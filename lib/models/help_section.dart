      ...
      HelpSection(
        ...
        items: [
          ...
          HelpItem(
            ...
            content: 'На вкладке "Подопечные" отображаются все ваши подопечные (дети, внуки и т.д.):\n• ФИО подопечного\n• Дата рождения\n• Возраст\n• Родственная связь',
      ...
      HelpSection(
        ...
        items: [
          HelpItem(
            ...
            content: 'В верхней части экрана отображается статистика:\n• 📊 Всего заявок\n• ✅ Выполнено\n• ⏳ В обработке\n• ❌ Отменено',
            icon: Icons.analytics,
          ),
          HelpItem(
            title: 'Статусы курсов',
            content: 'Цветовая индикация статусов:\n🟢 Зеленый - Выполнена\n🟠 Оранжевый - В обработке\n🔵 Синий - В плане заезда\n🔴 Красный - Отменена\n⚪ Серый - Неизвестно',
            icon: Icons.color_lens,
          ),
          HelpItem(
            title: 'Детальная информация',
            content: 'Нажмите на карточку курса, чтобы увидеть:\n• Полное описание заявки\n• Номер записи на курс\n• Даты начала и окончания\n• Контакты для связи',
            icon: Icons.details,
          ),
          HelpItem(
            title: 'Контакты',
            content: 'В детальной информации доступны интерактивные контакты:\n📞 Телефон - нажмите, чтобы позвонить\n✉️ Email - нажмите, чтобы отправить письмо',
